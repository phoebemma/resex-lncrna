...
annotation<- getBM(attributes = c("gene_biotype", "external_gene_name"), values =nonzero$gene_name, mart = ensembl )
annotation <- inner_join(nonzero, annotation, by= c("gene_name" = "external_gene_name"))#%>%
