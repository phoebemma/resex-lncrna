...
Due to the nested ature of the data, a model was used to evaluate coexpression mRNA coding genes. The model took into cognizance the exercise time and condition
