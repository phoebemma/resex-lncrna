...
To compare the influence of the effective library size of all the genes, versus only those annotated as lncRNAs, two types of negative binomial regression models were built using Seqwrap, an R package developed in-house, one normalized using lncRNAs alone, and another using the full genes counts. All genes annotated as lncRNA by the Ensemble database in BioMart were extracted
...
Due to the nested nature of the data, a model was used to evaluate coexpression mRNA coding genes. The model took into cognizance the exercise time and condition
